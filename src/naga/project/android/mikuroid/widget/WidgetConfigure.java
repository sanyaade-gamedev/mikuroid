...
public class WidgetConfigure extends Activity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        this.findViewById(R.drawable.miku2).setOnClickListener(
                this.widgetClickListener);

        MikuHatsune.getInstance().create(
                (EditText) this.findViewById(R.id.miku_edittext));
    }
    ...
    View.OnClickListener widgetClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            // Miku has clicked.
            MikuHatsune.getInstance().click(v, WidgetConfigure.this,
                    appWidgetId);
